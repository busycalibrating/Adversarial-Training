...
print(
    "PGD, 40 iter: ",
    epoch_adversarial(dataloader, model_cnn_robust, pgd_linf, num_iter=40)[0],
)
print(
    "PGD, 100 iter: ",
    epoch_adversarial(dataloader, model_cnn_robust, pgd_linf, num_iter=100)[0],
)
